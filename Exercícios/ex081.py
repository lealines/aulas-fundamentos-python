...
def main():
    ...
    try:
        ...
        altura_str = input('Introduza a sua altura em metros (ex: 1.75): ').replace(',', '.')
        peso_str = input('Introduza o seu peso em kg (ex: 70): ').replace(',', '.')
        ...
        if altura <= 0 or peso <= 0:
            ...
            print('Erro: A altura e o peso devem ser maiores que zero.')
        ...
        print(f'Resultado gravado em "{caminho_ficheiro}"')
